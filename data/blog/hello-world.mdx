...
[^2]: I follow every episode of the podcast. The content is generally fresh, current, and well-researched. You need to listen to it with a filter (i.e. bearing in mind the hosts biases and incentives), but that's true for everything.
