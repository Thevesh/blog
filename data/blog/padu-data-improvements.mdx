...
date: '2024-01-24'
lastmod: '2024-01-24'
tags: ['dataviz','open-data','need-more-data']
draft: false
...
<LinkCard
  ...
  title="thevesh/charts/code-padu"
  description="Open-sourced code + data sources to produce the charts used in this blog post. All MIT-licensed, feel free to steal!"
  stats={[
    { label: "Python", value: "" },
    { label: "Accessed: 28 Sep 2023", value: "" }
  ]}
/>
