...
date: '2024-01-24'
lastmod: '2024-01-24'
tags: ['dataviz','open-data','not-enough-data']
draft: false
summary: 'The PADU team currently puts out some data everyday. I argue that we need better dataviz, more meaningful data, and better methods of providing the data.'
...
<p align="center">
<img src="https://thevesh-blog.s3.ap-southeast-1.amazonaws.com/padu_official.jpeg" alt="Daily PADU infographing showing 1,518,746 registrations as of 11.59pm on 22 January 2024" width="350"></img>
</p>
...
<p align="center">
<img src="https://thevesh-blog.s3.ap-southeast-1.amazonaws.com/padu_1_ts_abs.png" alt = "A vertical panel of 2 timeseries charts showing daily (top) and cumulative (bottom) registrations for PADU.
...
<p align="center">
<img src="https://thevesh-blog.s3.ap-southeast-1.amazonaws.com/padu_2_ts_rate.png" alt="A vertical panel of 2 timeseries charts showing daily (top) and cumulative (bottom) registrations for PADU as a % of citizens aged 18+.
...
<p align="center">
<img src="https://thevesh-blog.s3.ap-southeast-1.amazonaws.com/padu_4_bar_rate.png" alt="A bar chart showing registrations for PADU by state, as a % of citizens aged 18+ in descending order.
...
<p align="center">
<img src="https://thevesh-blog.s3.ap-southeast-1.amazonaws.com/padu_3_bar_abs.png" alt="A bar chart showing registrations for PADU by state in descending order.
...
[^1]: I personally don't agree with the methodology of asking people to submit 39 pieces of information, most of which the government should have anyway. However, that's a separate issue.
...
[^3]: Sex, age, and ethnicity are the ‘big 3' demographic variables in Malaysia. You'll see my refer to them constantly in my work. Sex and age are standard dimensions to look at in any country; ethnicity is a particular focus for Malaysia. In countries like South Korea and Japan which are ethically homogeneous, this dimension is meaningless and is seldom collected, much less analysed.

[^4]: Besides the small fact that this seems like a huge duplication, given that civil servants fill in their profile in [JPA's HRMIS system](https://docs.jpa.gov.my/docs/myppsm/PPSM/PO/Pengurusan-Maklumat-Sumber-Manusia/8/) to a much deeper extent than PADU requires.
